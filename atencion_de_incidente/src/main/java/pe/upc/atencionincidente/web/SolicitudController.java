...
public class SolicitudController {
		...
		/*----------send notificacion--------------*/
		 ...
		 Thread thread = new Thread("Enviando Notificacion") {
		      public void run(){
		         ...
		         enviarNotificacion(nroSolicitud,"Se procedio atencion de la solicitud ","pi2afpprima@gmail.com");
		      }
		   };
		   thread.start();
	...
	public @ResponseBody Map<String,String> getsol(@RequestParam("idSolicitud") String idSolicitud){

		Map<String,String> data = new HashMap<String,String>();
		
		System.out.println("getsol: " + idSolicitud.toString());
...
//		data.put("mensaje",mensaje);
    ...
    public @ResponseBody Map<String,String> multipleSave(@RequestParam("file") MultipartFile[] files,@ModelAttribute DetalleIncidenteForm form){
    	...
    	if (files != null && files.length >0) {
    		for(int i =0 ;i< files.length; i++){
    		 ...
    		 msg = this.saveFile(files[i],anexo);
 ...
 /*---------------------Notificacion---------------------*/
	...
	private String saveFile( MultipartFile file,AnexoSolicitud anexo){
    	...
    	String msg = "";
	      ...
	      try {
	                ...
	                BufferedOutputStream buffStream = 
	                        new BufferedOutputStream(new FileOutputStream(new File("D:/alan/files_upload/" + fileName)));
	...
	public void enviarNotificacion(String nroCti,String Mensaje,String correo){
		...
		// email subject
		String subject = "Solicitud de Atencion de Incidente";
