...
<html>
	<head>
 	...
 	<body>
    			...
    			<div class="container-fluid">
    				<div class="panel panel-default">
  						<div class="panel-heading">
    						<h3 class="panel-title">Consulta de Solicitudes de Atencion de Incidente</h3>
  						</div>
									...
									<div class="col-md-4">
    									<div class="form-horizontal">
  											<div class="form-group">
    											...
    											<div class="col-sm-7">
      												<form:select path="estado" id="estado"  cssClass="form-control" required="true" >
												    	<form:option value="" label="Seleccionar" />
    								...
    								<div class="col-md-4">
    									<div class="form-horizontal">
  											<div class="form-group">
    											...
    											<div class="col-sm-7">
      												<form:select path="sistemas" id="sistema" name="sistema" cssClass="form-control" required="true" >
									    				<form:option value="" label="Seleccionar" />
		...
		<script src="/atencion-incidente/resources/js/main2.js"></script>
 	</body>
