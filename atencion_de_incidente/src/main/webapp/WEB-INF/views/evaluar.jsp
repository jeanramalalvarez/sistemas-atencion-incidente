...
<html>
	<head>
 	...
 	<body>
 		...
 		<div class="wrap">
            ...
            <div class="row">
              <div class="col-md-6">
                <p style="text-align:right">Fecha de atencion <span id="fechaAtencion">26/08/2016</span></p>
              ...
              <div class="col-md-6">
                ...
                <div class="panel panel-default">
                  ...
                  <input type="text" value="${idSolicitud}" id="id_solicitud" name="id_solicitud" class="form-control">
 ...
 <form id="formEvaluar" enctype="multipart/form-data" method="post" accept-charset="utf-8">    
  <input type="hidden" value="${idSolicitud}"   name="nroSolicitud" class="form-control">
    			...
    			<div class="modal-content">
    				<div class="modal-body">
      					...
      					<div class="row" >
 							<div class="col-md-12">
								  <div class="form-group">
                              		<label for="descripcion" class="control-label">Detalle de Observacion:</label>
                              		<textarea id="modalObservacionDetalle" name="modalObservacionDetalle" class="form-control" rows="8" ></textarea>
                            	</div>
 							</div>
						</div>
                      ...
                      <div class="row">
    					...
    					<div class="modal-footer">
        					<button class="btn btn-primary" id="btnModalObservacionGuardar">Si</button>
    						<button class="btn btn-primary" id="btnModalNoGuardar">No</button>
      					</div>
