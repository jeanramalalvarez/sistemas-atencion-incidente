									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<div class="row">
													<div class="col-sm-2">
														<label for="descripcion" class="control-label">RUC:</label>
													</div>
													<div class="col-sm-4">
														<input type="text" id="nroRuc" name="nroRuc" class="form-control"></input>
													</div>
												</div>
												<br>
												<div class="row">
													...
													<div class="col-sm-9">
														<input type="text" id="rSocial" name="rSocial" class="form-control"></input>
													</div>
												</div>
												<br>
												<div class="row">
													...
													<div class="col-sm-4">
														<input type="text" id="cuspp" name="cuspp" class="form-control"></input>
													</div>
												</div>
												<br>
												<div class="row">
