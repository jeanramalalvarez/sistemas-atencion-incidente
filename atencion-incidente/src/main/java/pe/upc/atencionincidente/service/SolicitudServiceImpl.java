...
public class SolicitudServiceImpl implements SolicitudService {
	...
	public List<Map<String, Object>> getSolucionIncidente(EvaluarIncidenteForm form) {
		List<Map<String, Object>> list = solicitudDAO.getSolucionIncidente(form);
		return list;
	}
	...
	public String  getEmailOp(String idSolicitud){
		String email = solicitudDAO.getEmailOp(idSolicitud);
		return email;
	}
	...
	public String saveSolucionAF(EvaluarIncidenteForm form) {
		String newSolInc  = solicitudDAO.saveSolucionAF(form);
		return newSolInc;
	}
