...
public class KbSolucionCheck{
	
	private String idSolucionCh;
	...
	public void setIdSolucionCh(String idSolucionCh) {
		this.idSolucionCh = idSolucionCh;
	}
	...
	public String getTxtPautas() {
		return txtPautas;
	}

	public void setTxtPautas(String txtPautas) {
		this.txtPautas = txtPautas;
	}
